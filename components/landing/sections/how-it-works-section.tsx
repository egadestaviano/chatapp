    ...
    <section id="how" className="mx-auto max-w-6xl px-6 py-20 sm:py-24">
      <div className="flex gap-12">
        ...
        <div className="flex-1 text-center">
          ...
          <p className="mt-4 text-center text-[16px] leading-relaxed text-muted-foreground font-medium">
            Dark Chat is built for immediate deployment. <br/> Authenticate, connect, and broadcast your message in seconds.
          </p>

          <ol className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-3 place-items-center items-stretch">
            {steps.map((s) => (
              <li
                key={s.n}
                className="group relative flex flex-col items-center gap-4 bg-card/50 border border-border/50 rounded-3xl p-8 transition-all hover:border-primary/50 hover:bg-secondary/20 h-full overflow-hidden shadow-sm hover:shadow-[0_0_30px_rgba(16,185,129,0.05)]"
              >
                {/* Subtle green accent */}
                ...
                <div className="relative z-10 flex flex-col items-center flex-1">
                  ...
                  <p className="mt-2 text-[13px] leading-relaxed text-center text-muted-foreground flex-1  ">
                    {s.d}
                  </p>
                </div>
              </li>
